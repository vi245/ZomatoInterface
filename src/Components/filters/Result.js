...
const si=currPage*itemsPerPage-itemsPerPage;
  ...
  console.log(this.state.isPrevBtnActive);
    ...
    const renderPagination=noOfPages.map(number=>{
          if(number===1 && currPage===1)
          {
            return(
                ...
                <div key={number} className="link active">&nbsp;&nbsp;<a href="#" id={number} onClick={this.handleClick}>{number}</a></div>
             
            )
          }
          else if((number<upperPageBound +1)&&(number>lowerPageBound))
          {return(
            <div key={number} className="link">&nbsp;&nbsp;<a href="#" id={number} onClick={this.handleClick}>{number}</a></div>
              )
          }
    })
    let pageIncrementBtn=null;
       ...
       {
       pageIncrementBtn= <div className="link">&nbsp;&nbsp;<a href="#" onClick={this.btnIncrementClick}>&hellip;</a></div>
       }
       let pageDecrementBtn=null;
       if(lowerPageBound>=1)
       {
        pageDecrementBtn= <div className="link">&nbsp;&nbsp;<a href="#" onClick={this.btnDecrementClick}>&hellip;</a></div>
        }
       ...
       if (this.state.isPrevBtnActive==='disabled'){
        ...
        if(this.state.isPrevBtnActive===''){
          renderPrevArrow= <div className="link ">&nbsp;&nbsp;<a href="#" onClick={this.prevArrowClick}>&lt;</a></div>
        }
    ...
    let renderNextArrow=null;
     ...
     if (this.state.isNextBtnActive==='disabled'){
      ...
      if(this.state.isNextBtnActive===''){
        renderNextArrow= <div className="link ">&nbsp;&nbsp;<a href="#" onClick={this.nextArrowClick}>&gt;</a></div>
      }
